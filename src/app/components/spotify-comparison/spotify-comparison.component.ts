...
@Component({
  selector: 'app-spotify-comparison',
  templateUrl: './spotify-comparison.component.html',
  styleUrls: ['./spotify-comparison.component.scss']
})
export class SpotifyComparisonComponent implements OnInit {
  code:any;
  data:any;
  token:any;
  expires:any;
